...
#     def __init__(
#         self, map_dim, start_pose, start_radius, goal_pose, goal_radius, obstacles, k
#     ):
...
#     def __init__(
#         self, map_dim, start_pose, start_radius, goal_pose, goal_radius, obstacles, bias
#     ):
#         self.map_dim = self.mapx, self.mapy = map_dim
#         self.start_pose = self.sx, self.sy = start_pose
#         self.start_radius = start_radius
...
#                 if (
#                     abs(x - self.goal_pose[0]) <= self.goal_radius
#                     and abs(y - self.goal_pose[1]) <= self.goal_radius
#                 ):
...
#                 self.nodes[n].parent = nearest_node
#                 if (
#                     abs(pose[0] - self.goal_pose[0]) <= self.goal_radius
#                     and abs(pose[1] - self.goal_pose[1]) <= self.goal_radius
#                 ):
#                     self.gn = self.nodes[n]
